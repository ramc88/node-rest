# -*- coding: utf-8 -*-
"""expatsAndCountriesLinux.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/18Ar8sjcGlnaR9FE2AswrzRDRsFYuBD8m
"""
...
print(x)
np.savetxt("consultaExpatGeneral.csv", x, delimiter=",", fmt='%s')

_#LOOP

proc=1
count=1
x1 = np.array([["CODE","DATE", "TIME_INI", "TIME_FIN", "COUNTRY_ID", "COUNTRY_NAME", "M_E1_dau", "M_E1_mau", "M_E2_dau", "M_E2_mau",
         "M_E3_dau", "M_E3_mau", "F_E1_dau", "F_E1_mau", "F_E2_dau", "F_E2_mau", "F_E3_dau", "F_E3_mau"]])
...
for i in range(len(country_json)):
  ...
  country_id = country_json[i]['alpha-2']
...
print(x1)
np.savetxt("consultaPaisGeneral.csv", x1, delimiter=",", fmt='%s')